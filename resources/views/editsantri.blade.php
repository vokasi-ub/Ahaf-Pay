          ...
          <div class="row">
            <div class="col-md-8">
              <div class="card">
                ...
                <div class="card-body">
                @foreach ($data as $p)
                  <form method="post" action=/updatesantri>
                  {{ csrf_field() }}
                    <div class="row">
                      <div class="col-md-4">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="nama_santri" required="required" value="{{ $p->nama_santri }}">
                        </div>
                      </div>
                    </div>  
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="kamar" required="required" value="{{ $p->kamar }} ">
                        </div>
                      </div>
                    </div> 
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="tanggal_masuk" required="required" value="{{ $p->tanggal_masuk }}">
                        </div>
                      </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Update Santri</button>
