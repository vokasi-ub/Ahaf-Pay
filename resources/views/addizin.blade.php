            ...
            <div class="col-md-8">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title">Tambah Perizinan</h4>
                  <p class="card-category">Perizinan PPP. Al-Hikmah Al-Fathimiyyah</p>
                </div>
                <div class="card-body">
                  <form method="post" action=tambahizin>
                  {{ csrf_field() }}
                    <div class="row">
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">Id Izin (disabled)</label>
                          <input type="text" class="form-control" name="id_izin" disabled>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <button type="submit" class="btn btn-primary pull-right">Tambah Perizinan</button>
